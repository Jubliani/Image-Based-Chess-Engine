...
## How it works
 You feed in a FEN to the interface which the program uses to generate an image representing the board state. The image is then fed into the model of your choice for evaluation.
